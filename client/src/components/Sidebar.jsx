...
const Sidebar = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    ...
    >
      ...
      {/* New Chat Button */}
      <button onClick={createNewChat} className=" flex justify-center items-center w-full py-2 mt-10 text-white bg-gradient-to-r from-[#A456F7] to-[#3081F6] text-sm rounded-md cursor-pointer">
        ...
        {chats
          ...
          .map((chat) => (
            ...
            >
              ...
              <img
                src={assets.bin_icon} onClick={e => toast.promise(deleteChat(e,chat._id),{loading: "deleting..."})}
